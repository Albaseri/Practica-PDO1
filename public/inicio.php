...
// Llamamos al método read de la clase Producto y almacenamos en $productos
...
<body style="background-color:antiquewhite">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4" whitespace-nowrap>
                         <form action="delete.php" method="POST">
                            <!--Los valores de codigo se utilizan para identificar el producto-->
                            <input type="hidden" name="codigo" value="{$producto->codigo}"/> <!-- Campo entrada oculto. Se envía el cod del producto para saber cuál se elimina-->
                            <a href="update.php?codigo={$producto->codigo}"><i class="fa-solid fa-pencil text-yellow-400 mr-2"></i></a>
    ...
    <!-- Mensaje de acción realizada. Sweetalert -->
    <?php
